  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        ref={ref}
        className={cn(
          "bg-chart-background flex aspect-video justify-center rounded-2xl text-xs [&_.recharts-layer]:outline-none [&_.recharts-sector]:outline-none [&_.recharts-surface]:outline-none",
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "bg-chart-background grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-black/50 px-2.5 py-1.5 text-xs shadow-xl",
          className,
        )}
      >
